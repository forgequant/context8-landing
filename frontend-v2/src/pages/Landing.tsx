    ...
    <div className="min-h-screen bg-graphite-950 text-terminal-text font-mono px-6 py-8 md:py-12">
      ...
      <main className="max-w-6xl mx-auto">
        ...
        >
          ...
          <button
            onClick={handleAuth}
            className="bg-terminal-cyan text-graphite-950 px-6 py-2 rounded text-sm font-semibold hover:bg-terminal-cyan/90 transition-colors mb-2"
          >
            Start free (OAuth)
          </button>
        ...
        >
          ...
          <div className="bg-graphite-900 rounded-lg p-6 text-sm overflow-x-auto">
